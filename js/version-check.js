...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://raw.ihtw.moe/raw.githubusercontent.com/LibreSpark/6789TV/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/LibreSpark/6789TV/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://6789tv.top', '_blank');
                    });
                }
            }, 100);
        } else {
